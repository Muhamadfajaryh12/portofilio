...
const Card = ({ name, image, tech, category }) => {
  ...
  return (
    <div
      data-aos="zoom-in"
      className="h-full border-cyan-300 border-2  my-2 bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 shadow-sm p-3 relative  hover:-translate-y-10 duration-500"
    >
